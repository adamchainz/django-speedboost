...
from .context import (  # NOQA: imported for backwards compatibility
...
add_to_builtins('django_speedboost.template.defaulttags')
add_to_builtins('django_speedboost.template.defaultfilters')
add_to_builtins('django_speedboost.template.loader_tags')
